# streamlit_exoplanet_classifier_stars.py
# Usage:
#   pip install -r requirements.txt
#   streamlit run streamlit_exoplanet_classifier_stars.py
#
...
.stars::after, .stars2::after, .stars3::after {
    ...
    background: white;
    box-shadow:
        50px 100px white, 120px 200px white, 200px 50px white,
        300px 400px white, 400px 100px white, 500px 300px white,
        600px 150px white, 700px 200px white, 800px 400px white;
    animation: moveStars linear infinite, twinkle 2s infinite;
}

/* Different layers move at different speeds & twinkle rates */
.stars::after { animation-duration: 50s, 2s; }
.stars2::after {
    background: #aaa;
    box-shadow:
        80px 120px #aaa, 150px 300px #aaa, 250px 150px #aaa,
        350px 200px #aaa, 450px 350px #aaa, 550px 100px #aaa;
    animation-duration: 100s, 3s;
}
.stars3::after {
    background: #555;
    box-shadow:
        100px 50px #555, 200px 250px #555, 300px 100px #555,
        400px 300px #555, 500px 150px #555;
...
"""
st.markdown(stars_bg, unsafe_allow_html=True)
...
try:
    ...
    if XGB_VERSION >= (1, 3):
        ...
        XGB_AVAILABLE = False
        st.sidebar.warning(
            f"Detected xgboost {xgb_pkg.__version__} — old version may fail on some keywords. Upgrade recommended."
        )
except Exception as e:
    XGB_AVAILABLE = False
    try:
        st.sidebar.info("XGBoost import failed — option hidden.")
...
with st.spinner('Training...'):
    try:
        ...
        st.error("Training failed. See traceback:")
